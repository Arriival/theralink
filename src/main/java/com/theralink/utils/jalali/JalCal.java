package com.theralink.utils.jalali;
...
import com.theralink.utils.jalali.DateException;
import com.theralink.utils.jalali.JalCalUtil;
...
public class JalCal {
	 ...
	 * @throws com.theralink.utils.jalali.DateException if the input parameters are invalid or conversion fails
	 */
	public static Date jalaliToGregorian(int year, int month, int day, int hour, int min, int second) throws com.theralink.utils.jalali.DateException {
		// Validate basic input parameters
		if (year < 1000 || month > 12 || day > 31) {
			throw new com.theralink.utils.jalali.DateException();
		}
		// Convert Jalali date to Julian date
		long[] julian = com.theralink.utils.jalali.JalCalUtil.gregorianFromFixed(com.theralink.utils.jalali.JalCalUtil.fixedFromPersianFast(year, month, day));
	...
	public static String gregorianToJalaliDate(Date date, boolean dayAtFirst) {
		...
		long fixedFromGregorian = com.theralink.utils.jalali.JalCalUtil.fixedFromGregorian(
	 ...
	 * @throws com.theralink.utils.jalali.DateException if parsing fails
	 */
	private static int[] slashDateTokenizer(String input) throws com.theralink.utils.jalali.DateException {
	 ...
	 * @throws com.theralink.utils.jalali.DateException if conversion fails
	 */
	public static Date jalaliToGregorian(String input) throws com.theralink.utils.jalali.DateException {
		int[] intArr = slashDateTokenizer(input);
		try {
			// Try yyyy/mm/dd format first
			return jalaliToGregorian(intArr[0], intArr[1], intArr[2], 0, 0, 0);
		} catch (com.theralink.utils.jalali.DateException ex) {
	 ...
	 * @return Gregorian date as java.util.Date
	 * @throws com.theralink.utils.jalali.DateException if conversion fails or input format is invalid
	 */
	public static Date JalaliToGregorianWithHourMinSec(String input) throws com.theralink.utils.jalali.DateException {
