...
import com.theralink.service.baseInformation.IBaseInformationService;
import com.theralink.web.viewModel.baseInformation.BaseInformationViewModel;
...
public class BaseInformationController {
	...
	public BaseInformationViewModel load(@PathVariable String id) {
		return ModelMapperUtil.map(iBaseInformationService.authorizedLoad(id), BaseInformationViewModel.class);
	}

	@GetMapping(value = "/list")
	public List<BaseInformationViewModel> list() {
		return ModelMapperUtil.mapList(iBaseInformationService.getAllByClinicFilter(), BaseInformationViewModel.class);
	}
	...
	public boolean delete(@PathVariable String id) {
		return iBaseInformationService.deleteByAuthorizedId(id);
	}
